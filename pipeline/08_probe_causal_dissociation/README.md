...
| `r1_ruler_sensitivity.py` | review response: is "fidelity doesn't predict causal use" sensitive to which fidelity estimator you pick? (split-half / partial-lexical / held-out — no) |
...
own mouth on accuracy but not on group ordering. See
`../../docs/research-log.md` for the full arc.
